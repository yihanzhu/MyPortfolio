...
const NavBar = () => {
  ...
  return (
    <header
      ...
      dark:text-light z-10 lg:px-16 md:px-12 sm:px-8 sticky top-0
    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap ">
          ...
          <motion.a
            href="https://github.com/yihanzhu"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://www.linkedin.com/in/yihan-z/"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
        ...
        >
          ...
          <nav className="flex items-center justify-center flex-wrap">
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 mr-3 dark:text-dark text-light "
            >
              <InstagramIcon />
            </motion.a>
            <motion.a
            ...
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 ml-3 dark:text-dark text-light "
            >
              <LinkedInIcon />
            </motion.a>
          </nav>
